    ...
    <ul className="grid grid-cols-2 w-full gap-5">
      {games.map((game) => (
        ...
        >
          ...
          <div
            className={cn(
              "  w-full h-full -translate-y-[6px] group-hover:-translate-y-[2px]  group-hover:brightness-105   duration-300    overflow-hidden rounded-2xl absolute    transition-all z-10 inset-0 shadow-md  ",
