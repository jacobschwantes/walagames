      ...
      <div className="w-full mt-auto">
        {session && session.user ? (
          <div className="flex gap-1.5 h-full">
            <Link href="/profile" className="flex gap-3 bg-[#21252e] px-3 py-3 rounded-xl select-none cursor-pointer items-center flex-1">
...
export function SignOut() {
  return (
    ...
    >
      <button className="bg-[#21252e] h-full aspect-square px-3 py-3 flex items-center justify-center rounded-xl">
